        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <ul class="nav nav-tabs" style={tabHelpStyle}>
              ...
              <li class="active col-md-3"><a href="#contact" style={linkHelpStyle} data-toggle="tab">Contact an Official</a></li>
              <li class="col-md-3"><a href="#faq" style={linkHelpStyle} data-toggle="tab">Frequently asked questions</a></li>
